/**
 * Página de Listagem de Ordens de Serviço (Beta)
...
export const ServiceOrdersPage = () => {
  ...
  const handleStatusUpdate = (serviceOrderId: string, newStatus: ServiceOrderStatus) => {
    updateStatus({ id: serviceOrderId, status: newStatus });
  };
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setFilters(prev => ({ ...prev, status: value as ServiceOrderStatus | 'all' }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setFilters(prev => ({ ...prev, priority: value as ServiceOrderPriority | 'all' }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
